...
<header class="d-flex flex-wrap text-bg-warning align-items-center justify-content-center justify-content-md-between px-3 py-2 border-bottom">
	<div class="col-md-3 mb-2 mb-md-0">
		<a href="/ad_matjjang" class="d-inline-flex link-body-emphasis text-decoration-none">
	...
	<ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
		...
		<li><a href="" class="nav-link px-4 tx-main text-white">통계</a></li>
